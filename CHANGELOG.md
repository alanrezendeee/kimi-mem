...
- `RELEASE.md`: documented PR-based release workflow
- GitHub Pages workflow with concurrency control
- GitHub Actions release workflow using official `pypa/gh-action-pypi-publish`

### Changed

- Release workflow now uses official PyPA action for better error handling
